...
// profileNameHtml.addEventListener("click",dropup)
loggedout.addEventListener('click',logout)
// updateButton.addEventListener('click',update)
// createPost.addEventListener('click',createdown)
// loggedout.addEventListener('mousemove',logouthover)
// notification.addEventListener('mousemove',notificationhover)